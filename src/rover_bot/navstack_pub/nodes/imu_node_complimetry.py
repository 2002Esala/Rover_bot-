...
def imu_callback(data):
    ...
    # Use complementary filter to fuse gyroscope and accelerometer data
    accel_x = array_data[0]
    accel_y = array_data[1]
    accel_z = array_data[2]
    ...
    # Combine gyro and accel angles using complementary filter
    roll = gyro_alpha * (roll + gyro_x * dt) + accel_alpha * accel_roll
    pitch = gyro_alpha * (pitch + gyro_y * dt) + accel_alpha * accel_pitch
